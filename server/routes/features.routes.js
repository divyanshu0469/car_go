...
import { getProfile, publish, setProfile, changePass, search, myRides, deleteRide, getPublicProfile, getDetails, setAadhar, setLicense, activeRides } from '../controllers/features.controller.js';
...
router.post('/activeRides', activeRides);
